...
def reorder_place_keys(trip_data):
    ordered_keys = ['placeId', 'placeName', 'category', 'duration', 'order', 'new_order', 'timeOfDay', 'music_bool',
                    'top_musicId', 'song_title', 'artist_name', 'spotify_id', 'price']
    ...
    return {"recommendations": trip_data}
